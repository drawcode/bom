...
class GameSessionDataResult(object):
...
class GameSessionData(BaseMeta):

    def __init__(self):
        super(GameSessionData, self).__init__()
        #self.__dict__.update(entries)
        self.data_layer_enemy = None
        self.data_layer_actors = None
        self.data_results = None
        self.data = None
        self.data_layer_projectile = None
