...
//-------------------------------------------------
if (!window.gameversesprofile)
    window.gameversesprofile = {};
    
if (!window.gameversesprofile)
    window.gameversesprofile = {};
    
if (!window.gameversesprofile.base_entity)
    window.gameversesprofile.base_entity = {};
   
if (!window.gameversesprofile.base_meta)
    window.gameversesprofile.base_meta = {};
   
if (!window.gameversesprofile.profile)
    window.gameversesprofile.profile = {};
   
if (!window.gameversesprofile.profile_type)
    window.gameversesprofile.profile_type = {};
   
if (!window.gameversesprofile.profile_attribute)
    window.gameversesprofile.profile_attribute = {};
   
if (!window.gameversesprofile.profile_attribute_text)
    window.gameversesprofile.profile_attribute_text = {};
   
if (!window.gameversesprofile.profile_attribute_data)
    window.gameversesprofile.profile_attribute_data = {};
   
if (!window.gameversesprofile.profile_device)
    window.gameversesprofile.profile_device = {};
   
if (!window.gameversesprofile.country)
    window.gameversesprofile.country = {};
   
if (!window.gameversesprofile.state)
    window.gameversesprofile.state = {};
   
if (!window.gameversesprofile.city)
    window.gameversesprofile.city = {};
   
if (!window.gameversesprofile.postal_code)
    window.gameversesprofile.postal_code = {};
   

//-------------------------------------------------
gameversesprofile.profile.global = function() {
...
var gameversesprofile_profile_global = new gameversesprofile.profile.global();
       
//-------------------------------------------------
gameversesprofile.base_entity = function() {
    this.fn_callback;
    this.fn_callbacks;
    return_profile_obj = this;
}        
        
gameversesprofile.base_entity.prototype = {
    //-------------------------------------------------
    init: function() {
...
//-------------------------------------------------
gameversesprofile.base_meta = function() {
    this.fn_callback;
    this.fn_callbacks;
    return_profile_obj = this;
}        
        
gameversesprofile.base_meta.prototype = {
    //-------------------------------------------------
    init: function() {
...
//-------------------------------------------------
gameversesprofile.profile = function() {
    this.fn_callback;
    this.fn_callbacks;
    return_profile_obj = this;
}        
        
gameversesprofile.profile.prototype = {
    //-------------------------------------------------
    init: function() {
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_service + 'count'
                + ""
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_service + 'browse'
                + "/by-filter"
                + "/@page/" + page
                + "/@page_size/" + page_size
                + "/@filter/" + filter
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_service + 'set'
                + "/by-uuid"
                + "/@uuid/" + uuid            
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_service + 'del'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_service + 'get'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
...
//-------------------------------------------------
gameversesprofile.profile_type = function() {
    this.fn_callback;
    this.fn_callbacks;
    return_profile_obj = this;
}        
        
gameversesprofile.profile_type.prototype = {
    //-------------------------------------------------
    init: function() {
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_type_service + 'count'
                + ""
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_type_service + 'browse'
                + "/by-filter"
                + "/@page/" + page
                + "/@page_size/" + page_size
                + "/@filter/" + filter
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_type_service + 'set'
                + "/by-uuid"
                + "/@uuid/" + uuid            
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_type_service + 'del'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_type_service + 'get'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
...
//-------------------------------------------------
gameversesprofile.profile_attribute = function() {
    this.fn_callback;
    this.fn_callbacks;
    return_profile_obj = this;
}        
        
gameversesprofile.profile_attribute.prototype = {
    //-------------------------------------------------
    init: function() {
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_service + 'count'
                + ""
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_service + 'browse'
                + "/by-filter"
                + "/@page/" + page
                + "/@page_size/" + page_size
                + "/@filter/" + filter
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_service + 'set'
                + "/by-uuid"
                + "/@uuid/" + uuid            
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_service + 'del'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_service + 'get'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
...
//-------------------------------------------------
gameversesprofile.profile_attribute_text = function() {
    this.fn_callback;
    this.fn_callbacks;
    return_profile_obj = this;
}        
        
gameversesprofile.profile_attribute_text.prototype = {
    //-------------------------------------------------
    init: function() {
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_text_service + 'count'
                + ""
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_text_service + 'browse'
                + "/by-filter"
                + "/@page/" + page
                + "/@page_size/" + page_size
                + "/@filter/" + filter
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_text_service + 'set'
                + "/by-uuid"
                + "/@uuid/" + uuid            
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_text_service + 'del'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_text_service + 'get'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
...
//-------------------------------------------------
gameversesprofile.profile_attribute_data = function() {
    this.fn_callback;
    this.fn_callbacks;
    return_profile_obj = this;
}        
        
gameversesprofile.profile_attribute_data.prototype = {
    //-------------------------------------------------
    init: function() {
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_data_service + 'count'
                + ""
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_data_service + 'browse'
                + "/by-filter"
                + "/@page/" + page
                + "/@page_size/" + page_size
                + "/@filter/" + filter
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_data_service + 'set'
                + "/by-uuid"
                + "/@uuid/" + uuid            
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_data_service + 'del'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_attribute_data_service + 'get'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
...
//-------------------------------------------------
gameversesprofile.profile_device = function() {
    this.fn_callback;
    this.fn_callbacks;
    return_profile_obj = this;
}        
        
gameversesprofile.profile_device.prototype = {
    //-------------------------------------------------
    init: function() {
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_device_service + 'count'
                + ""
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_device_service + 'browse'
                + "/by-filter"
                + "/@page/" + page
                + "/@page_size/" + page_size
                + "/@filter/" + filter
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_device_service + 'set'
                + "/by-uuid"
                + "/@uuid/" + uuid            
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_device_service + 'del'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.profile_device_service + 'get'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
...
//-------------------------------------------------
gameversesprofile.country = function() {
    this.fn_callback;
    this.fn_callbacks;
    return_profile_obj = this;
}        
        
gameversesprofile.country.prototype = {
    //-------------------------------------------------
    init: function() {
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.country_service + 'count'
                + ""
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.country_service + 'browse'
                + "/by-filter"
                + "/@page/" + page
                + "/@page_size/" + page_size
                + "/@filter/" + filter
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.country_service + 'set'
                + "/by-uuid"
                + "/@uuid/" + uuid            
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.country_service + 'del'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.country_service + 'get'
                + ""
                ;
...
//-------------------------------------------------
gameversesprofile.state = function() {
    this.fn_callback;
    this.fn_callbacks;
    return_profile_obj = this;
}        
        
gameversesprofile.state.prototype = {
    //-------------------------------------------------
    init: function() {
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.state_service + 'count'
                + ""
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.state_service + 'browse'
                + "/by-filter"
                + "/@page/" + page
                + "/@page_size/" + page_size
                + "/@filter/" + filter
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.state_service + 'set'
                + "/by-uuid"
                + "/@uuid/" + uuid            
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.state_service + 'del'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.state_service + 'get'
                + ""
                ;
...
//-------------------------------------------------
gameversesprofile.city = function() {
    this.fn_callback;
    this.fn_callbacks;
    return_profile_obj = this;
}        
        
gameversesprofile.city.prototype = {
    //-------------------------------------------------
    init: function() {
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.city_service + 'count'
                + ""
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.city_service + 'browse'
                + "/by-filter"
                + "/@page/" + page
                + "/@page_size/" + page_size
                + "/@filter/" + filter
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.city_service + 'set'
                + "/by-uuid"
                + "/@uuid/" + uuid            
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.city_service + 'del'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.city_service + 'get'
                + ""
                ;
...
//-------------------------------------------------
gameversesprofile.postal_code = function() {
    this.fn_callback;
    this.fn_callbacks;
    return_profile_obj = this;
}        
        
gameversesprofile.postal_code.prototype = {
    //-------------------------------------------------
    init: function() {
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.postal_code_service + 'count'
                + ""
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.postal_code_service + 'browse'
                + "/by-filter"
                + "/@page/" + page
                + "/@page_size/" + page_size
                + "/@filter/" + filter
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.postal_code_service + 'set'
                + "/by-uuid"
                + "/@uuid/" + uuid            
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.postal_code_service + 'del'
                + "/by-uuid"
                + "/@uuid/" + uuid            
                ;
    ...
    (
        ...
        this.fn_callback = fn;
        var service_url = gameversesprofile_profile_global.postal_code_service + 'get'
                + ""
                ;
