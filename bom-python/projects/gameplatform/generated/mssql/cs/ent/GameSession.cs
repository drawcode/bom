...
namespace platform.ent {
        ...
        public class GameSessionResult : BaseObjectResult {
        ...
        public List<Dictionary<string, object>> GetListDict(List<GameSession> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (GameSession obj in data) {
        ...
        public List<GameSession> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    GameSession objectValue = (GameSession)obj.Value;
