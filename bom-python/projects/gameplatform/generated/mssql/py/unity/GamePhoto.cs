...
public class GamePhotos<T> : DataObjects<T> where T : new() {

    private static T current;
    private static volatile GamePhotos<T> instance;
    private static object syncRoot = new Object();

    private string DATA_KEY = "game_photo-data";
    ...
    public static GamePhotos<T> Instance {
        get {
            if (instance == null) {
                lock (syncRoot) {
                    if (instance == null)
                        instance = new GamePhotos<T>();
                }
            }
            return instance;
        }
    ...
    public GamePhotos(bool loadData) {
        Reset();
