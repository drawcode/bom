...
public class GameVideos<T> : DataObjects<T> where T : new() {

    private static T current;
    private static volatile GameVideos<T> instance;
    private static object syncRoot = new Object();

    private string DATA_KEY = "game_video-data";
    ...
    public static GameVideos<T> Instance {
        get {
            if (instance == null) {
                lock (syncRoot) {
                    if (instance == null)
                        instance = new GameVideos<T>();
                }
            }
            return instance;
        }
    ...
    public GameVideos(bool loadData) {
        Reset();
