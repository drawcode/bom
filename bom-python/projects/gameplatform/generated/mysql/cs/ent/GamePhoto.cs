...
namespace platform.ent {
        ...
        public class GamePhotoResult : BaseObjectResult {
    
        public List<GamePhoto> data = new List<GamePhoto>();

        public GamePhotoResult() {
            Reset();
        }
        ...
        public List<Dictionary<string, object>> GetListDict(List<GamePhoto> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (GamePhoto obj in data) {
        ...
        public List<GamePhoto> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    GamePhoto objectValue = (GamePhoto)obj.Value;
    ...
    public class GamePhoto : BaseMeta {
