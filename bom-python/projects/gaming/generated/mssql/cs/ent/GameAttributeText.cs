...
namespace gaming.ent {
        ...
        public class GameAttributeTextResult : BaseObjectResult {
    
        public List<GameAttributeText> data = new List<GameAttributeText>();

        public GameAttributeTextResult() {
            Reset();
        }
        ...
        public List<Dictionary<string, object>> GetListDict(List<GameAttributeText> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (GameAttributeText obj in data) {
        ...
        public List<GameAttributeText> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    GameAttributeText objectValue = (GameAttributeText)obj.Value;
