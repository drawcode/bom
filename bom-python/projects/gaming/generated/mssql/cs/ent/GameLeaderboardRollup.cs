...
namespace gaming.ent {
        ...
        public class GameLeaderboardRollupResult : BaseObjectResult {
    
        public List<GameLeaderboardRollup> data = new List<GameLeaderboardRollup>();

        public GameLeaderboardRollupResult() {
            Reset();
        }
        ...
        public List<Dictionary<string, object>> GetListDict(List<GameLeaderboardRollup> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (GameLeaderboardRollup obj in data) {
        ...
        public List<GameLeaderboardRollup> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    GameLeaderboardRollup objectValue = (GameLeaderboardRollup)obj.Value;
    ...
    public class GameLeaderboardRollup : BaseEntity {
    
        public GameLeaderboardRollup() {
