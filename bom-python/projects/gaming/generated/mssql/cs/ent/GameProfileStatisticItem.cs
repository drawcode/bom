...
namespace gaming.ent {
        ...
        public class GameProfileStatisticItemResult : BaseObjectResult {
    
        public List<GameProfileStatisticItem> data = new List<GameProfileStatisticItem>();

        public GameProfileStatisticItemResult() {
            Reset();
        }
        ...
        public List<Dictionary<string, object>> GetListDict(List<GameProfileStatisticItem> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (GameProfileStatisticItem obj in data) {
        ...
        public List<GameProfileStatisticItem> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    GameProfileStatisticItem objectValue = (GameProfileStatisticItem)obj.Value;
    ...
    public class GameProfileStatisticItem : BaseEntity {
    
        public GameProfileStatisticItem() {
