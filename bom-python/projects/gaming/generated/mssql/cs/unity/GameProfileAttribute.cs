...
public class GameProfileAttributes<T> : DataObjects<T> where T : new() {

    private static T current;
    private static volatile GameProfileAttributes<T> instance;
    private static object syncRoot = new Object();

    private string DATA_KEY = "game_profile_attribute-data";
    ...
    public static GameProfileAttributes<T> Instance {
        get {
            if (instance == null) {
                lock (syncRoot) {
                    if (instance == null)
                        instance = new GameProfileAttributes<T>();
                }
            }
            return instance;
        }
    ...
    public GameProfileAttributes() {
        Reset();
    }

    public GameProfileAttributes(bool loadData) {
        Reset();
