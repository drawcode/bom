...
namespace gaming.ent {
        ...
        public class GameStatisticLeaderboardRollupResult : BaseObjectResult {
    
        public List<GameStatisticLeaderboardRollup> data = new List<GameStatisticLeaderboardRollup>();

        public GameStatisticLeaderboardRollupResult() {
            Reset();
        }
        ...
        public List<Dictionary<string, object>> GetListDict(List<GameStatisticLeaderboardRollup> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (GameStatisticLeaderboardRollup obj in data) {
        ...
        public List<GameStatisticLeaderboardRollup> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    GameStatisticLeaderboardRollup objectValue = (GameStatisticLeaderboardRollup)obj.Value;
