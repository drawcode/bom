...
namespace gaming.ent {
        ...
        public class GameVideoResult : BaseObjectResult {
    
        public List<GameVideo> data = new List<GameVideo>();

        public GameVideoResult() {
            Reset();
        }
        ...
        public List<Dictionary<string, object>> GetListDict(List<GameVideo> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (GameVideo obj in data) {
        ...
        public List<GameVideo> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    GameVideo objectValue = (GameVideo)obj.Value;
    ...
    public class GameVideo : BaseMeta {
