...
public class GameProfileAttributeTexts<T> : DataObjects<T> where T : new() {

    private static T current;
    private static volatile GameProfileAttributeTexts<T> instance;
    private static object syncRoot = new Object();

    private string DATA_KEY = "game_profile_attribute_text-data";
    ...
    public static GameProfileAttributeTexts<T> Instance {
        get {
            if (instance == null) {
                lock (syncRoot) {
                    if (instance == null)
                        instance = new GameProfileAttributeTexts<T>();
                }
            }
            return instance;
        }
    ...
    public GameProfileAttributeTexts() {
        Reset();
    }

    public GameProfileAttributeTexts(bool loadData) {
        Reset();
