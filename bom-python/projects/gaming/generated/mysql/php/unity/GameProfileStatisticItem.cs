...
public class GameProfileStatisticItems<T> : DataObjects<T> where T : new() {

    private static T current;
    private static volatile GameProfileStatisticItems<T> instance;
    private static object syncRoot = new Object();

    private string DATA_KEY = "game_profile_statistic_item-data";
    ...
    public static GameProfileStatisticItems<T> Instance {
        get {
            if (instance == null) {
                lock (syncRoot) {
                    if (instance == null)
                        instance = new GameProfileStatisticItems<T>();
                }
            }
            return instance;
        }
    ...
    public GameProfileStatisticItems() {
        Reset();
    }

    public GameProfileStatisticItems(bool loadData) {
        Reset();
