...
namespace gaming.ent {
        ...
        public class GameAttributeDataResult : BaseObjectResult {
    
        public List<GameAttributeData> data = new List<GameAttributeData>();

        public GameAttributeDataResult() {
            Reset();
        }
        ...
        public List<Dictionary<string, object>> GetListDict(List<GameAttributeData> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (GameAttributeData obj in data) {
        ...
        public List<GameAttributeData> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    GameAttributeData objectValue = (GameAttributeData)obj.Value;
