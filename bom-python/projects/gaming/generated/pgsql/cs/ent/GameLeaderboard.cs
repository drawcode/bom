...
namespace gaming.ent {
        ...
        public class GameLeaderboardResult : BaseObjectResult {
    
        public List<GameLeaderboard> data = new List<GameLeaderboard>();

        public GameLeaderboardResult() {
            Reset();
        }
        ...
        public List<Dictionary<string, object>> GetListDict(List<GameLeaderboard> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (GameLeaderboard obj in data) {
        ...
        public List<GameLeaderboard> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    GameLeaderboard objectValue = (GameLeaderboard)obj.Value;
