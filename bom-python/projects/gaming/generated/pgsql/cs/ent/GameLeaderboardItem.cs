...
namespace gaming.ent {
        ...
        public class GameLeaderboardItemResult : BaseObjectResult {
    
        public List<GameLeaderboardItem> data = new List<GameLeaderboardItem>();

        public GameLeaderboardItemResult() {
            Reset();
        }
        ...
        public List<Dictionary<string, object>> GetListDict(List<GameLeaderboardItem> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (GameLeaderboardItem obj in data) {
