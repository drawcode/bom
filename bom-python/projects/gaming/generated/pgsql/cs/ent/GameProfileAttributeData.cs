...
namespace gaming.ent {
        ...
        public class GameProfileAttributeDataResult : BaseObjectResult {
    
        public List<GameProfileAttributeData> data = new List<GameProfileAttributeData>();

        public GameProfileAttributeDataResult() {
            Reset();
        }
        ...
        public List<Dictionary<string, object>> GetListDict(List<GameProfileAttributeData> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (GameProfileAttributeData obj in data) {
