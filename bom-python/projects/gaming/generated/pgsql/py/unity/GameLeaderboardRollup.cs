...
public class GameLeaderboardRollups<T> : DataObjects<T> where T : new() {

    private static T current;
    private static volatile GameLeaderboardRollups<T> instance;
    private static object syncRoot = new Object();

    private string DATA_KEY = "game_leaderboard_rollup-data";
    ...
    public static GameLeaderboardRollups<T> Instance {
        get {
            if (instance == null) {
                lock (syncRoot) {
                    if (instance == null)
                        instance = new GameLeaderboardRollups<T>();
                }
            }
            return instance;
        }
    ...
    public GameLeaderboardRollups() {
        Reset();
    }

    public GameLeaderboardRollups(bool loadData) {
        Reset();
