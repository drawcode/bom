...
public class GameStatisticLeaderboardItems<T> : DataObjects<T> where T : new() {

    private static T current;
    private static volatile GameStatisticLeaderboardItems<T> instance;
    private static object syncRoot = new Object();

    private string DATA_KEY = "game_statistic_leaderboard_item-data";
    ...
    public static GameStatisticLeaderboardItems<T> Instance {
        get {
            if (instance == null) {
                lock (syncRoot) {
                    if (instance == null)
                        instance = new GameStatisticLeaderboardItems<T>();
                }
            }
            return instance;
        }
    ...
    public GameStatisticLeaderboardItems() {
        Reset();
    }

    public GameStatisticLeaderboardItems(bool loadData) {
        Reset();
