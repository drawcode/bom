...
namespace platform.ent {
        ...
        public class GameStatisticResult : BaseObjectResult {
    
        public List<GameStatistic> data = new List<GameStatistic>();

        public GameStatisticResult() {
            Reset();
        }
        ...
        public List<Dictionary<string, object>> GetListDict(List<GameStatistic> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (GameStatistic obj in data) {
        ...
        public List<GameStatistic> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    GameStatistic objectValue = (GameStatistic)obj.Value;
