...
namespace platform.ent {
        ...
        public class OfferCategoryAssocResult : BaseObjectResult {
    
        public List<OfferCategoryAssoc> data = new List<OfferCategoryAssoc>();

        public OfferCategoryAssocResult() {
            Reset();
        }
        ...
        public List<Dictionary<string, object>> GetListDict(List<OfferCategoryAssoc> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (OfferCategoryAssoc obj in data) {
        ...
        public List<OfferCategoryAssoc> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    OfferCategoryAssoc objectValue = (OfferCategoryAssoc)obj.Value;
