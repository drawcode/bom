...
namespace platform.ent {
        ...
        public class VideoResult : BaseObjectResult {
        ...
        public List<Dictionary<string, object>> GetListDict(List<Video> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (Video obj in data) {
        ...
        public List<Video> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    Video objectValue = (Video)obj.Value;
