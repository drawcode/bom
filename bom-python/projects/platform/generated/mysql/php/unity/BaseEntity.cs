...
public class BaseEntity  {
    ...
    public Date date_modified { get; set; }
	...
	if(dict.ContainsKey("date_modified")) {
	    if(dict["date_modified"] != null) {
	    	date_modified = DataType.Instance.FillDate(dict["date_modified"]);
	    }		
	}
	if(dict.ContainsKey("active")) {
	    if(dict["active"] != null) {
	    	active = DataType.Instance.FillBoolean(dict["active"]);
	    }		
	}
	if(dict.ContainsKey("date_created")) {
	    if(dict["date_created"] != null) {
	    	date_created = DataType.Instance.FillDate(dict["date_created"]);
	    }		
	}
