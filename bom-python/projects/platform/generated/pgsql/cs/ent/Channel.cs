...
namespace platform.ent {
        ...
        public class ChannelResult : BaseObjectResult {
        ...
        public List<Dictionary<string, object>> GetListDict(List<Channel> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (Channel obj in data) {
        ...
        public List<Channel> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    Channel objectValue = (Channel)obj.Value;
