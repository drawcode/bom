...
namespace platform.ent {
        ...
        public class GameAchievementResult : BaseObjectResult {
    
        public List<GameAchievement> data = new List<GameAchievement>();

        public GameAchievementResult() {
            Reset();
        }
        ...
        public List<Dictionary<string, object>> GetListDict(List<GameAchievement> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (GameAchievement obj in data) {
        ...
        public List<GameAchievement> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    GameAchievement objectValue = (GameAchievement)obj.Value;
