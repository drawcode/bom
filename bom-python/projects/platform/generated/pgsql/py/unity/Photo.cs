...
public class Photos<T> : DataObjects<T> where T : new() {

    private static T current;
    private static volatile Photos<T> instance;
    private static object syncRoot = new Object();

    private string DATA_KEY = "photo-data";
    ...
    public static Photos<T> Instance {
        get {
            if (instance == null) {
                lock (syncRoot) {
                    if (instance == null)
                        instance = new Photos<T>();
                }
            }
            return instance;
        }
