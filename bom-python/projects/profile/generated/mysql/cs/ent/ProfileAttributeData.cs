...
namespace profile.ent {
        ...
        public class ProfileAttributeDataResult : BaseObjectResult {
    
        public List<ProfileAttributeData> data = new List<ProfileAttributeData>();

        public ProfileAttributeDataResult() {
            Reset();
        }
        ...
        public List<Dictionary<string, object>> GetListDict(List<ProfileAttributeData> data) {
            
            List<Dictionary<string, object>> dictList = new List<Dictionary<string, object>>();
            
            foreach (ProfileAttributeData obj in data) {
        ...
        public List<ProfileAttributeData> GetList(List<Dictionary<string, object>> dictList) {
            
            data.Clear();
            
            foreach (Dictionary<string, object> dict in dictList) {
                foreach (KeyValuePair<string, object> obj in dict) {
                    ProfileAttributeData objectValue = (ProfileAttributeData)obj.Value;
