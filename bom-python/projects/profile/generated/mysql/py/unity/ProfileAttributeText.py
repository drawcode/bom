...
public class ProfileAttributeTexts<T> : DataObjects<T> where T : new() {

    private static T current;
    private static volatile ProfileAttributeTexts<T> instance;
    private static object syncRoot = new Object();

    private string DATA_KEY = "profile_attribute_text-data";
    ...
    public static ProfileAttributeTexts<T> Instance {
        get {
            if (instance == null) {
                lock (syncRoot) {
                    if (instance == null)
                        instance = new ProfileAttributeTexts<T>();
                }
            }
            return instance;
        }
    ...
    public ProfileAttributeTexts() {
        Reset();
    }

    public ProfileAttributeTexts(bool loadData) {
        Reset();
